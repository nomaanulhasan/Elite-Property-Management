...
const ImageActionCard = ({ src, alt }) => {
  return (
    <div className="relative overflow-hidden">
      ...
      <button className="absolute bottom-0 right-0 w-11 h-11 bg-text rounded-full flex items-center justify-center text-white outline outline-white outline-[0.875rem]">
